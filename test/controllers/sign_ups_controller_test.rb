...
class SignUpsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sign_up" do
    assert_difference('SignUp.count') do
      post sign_ups_url, params: { sign_up: { address: @sign_up.address, email: @sign_up.email, name: @sign_up.name, password: @sign_up.password } }
    end
  ...
  test "should update sign_up" do
    patch sign_up_url(@sign_up), params: { sign_up: { address: @sign_up.address, email: @sign_up.email, name: @sign_up.name, password: @sign_up.password } }
